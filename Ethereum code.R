...
eth_garch_sstd= etherum_garch_vol[,-1]
...
eth_nagarch_sstd= nagarch_binance_eth[,-1]
...
eth_gjrgarch_sstd= eth_gjrgarch[,-1]
...
eth_msgarch_var_01= read.csv("eth_msgarch_var_01_binance.csv")
eth_msgarch_var_01= eth_msgarch_var_01[,-1]

eth_msgarch_vol= read.csv("eth_msgarch_vol_binance.csv")
eth_msgarch_vol= eth_msgarch_vol[,-1]

eth_msgarch_es_01= read.csv("eth_msgarch_es_01_binance.csv")
eth_msgarch_es_01= eth_msgarch_es_01[,-1]

eth_msgarch_var_05= read.csv("eth_msgarch_var_05_binance.csv")
eth_msgarch_var_05= eth_msgarch_var_05[,-1]
eth_msgarch_es_05= read.csv("eth_msgarch_es_05_binance.csv")
eth_msgarch_es_05= eth_msgarch_es_05[,-1]

eth_msgarch_var_025= read.csv("eth_msgarch_var_025_binance.csv")
eth_msgarch_var_025= eth_msgarch_var_025[,-1]
eth_msgarch_es_025= read.csv("eth_msgarch_es_025_binance.csv")
eth_msgarch_es_025= eth_msgarch_es_025[,-1]
...
adj_eth_vol_nor= sqrt(adj_eth_vol_nor_binance)
...
adj_eth_t_vol= sqrt(eth_scaling_factor_t_binance*(etherum_t_vol))
...
adj_eth_carr_vol= scaling_carr_binance*(etherum_carr_vol_binance)
...
eth_garch_ged= etherum_garch_vol_ged[,-1]
...
eth_nagarch_ged= nagarch_binance_eth_ged[,-1]
...
etherum_garch_mean_sged= fit_mean_garch
etherum_garch_sged= pre_garch_fast1

write.csv(etherum_garch_mean_sged,"etherum_garch_mean_sged.csv")
etherum_garch_mean= read.csv("etherum_garch_mean_sged.csv")
etherum_garch_mean= etherum_garch_mean[,-1]
write.csv(etherum_garch_sged,"etherum_garch_sged.csv")
etherum_garch_vol_sged= read.csv("etherum_garch_sged.csv")
eth_garch_sged= etherum_garch_vol_sged[,-1]
...
bid_nagarch_binance_eth_sged= pre_nagarch_binance
write.csv(bid_nagarch_binance_eth_sged,"bid_nagarch_binance_eth_sged.csv")
nagarch_binance_eth_sged= read.csv("bid_nagarch_binance_eth_sged.csv")
eth_nagarch_sged= nagarch_binance_eth_sged[,-1]
...
eth_gjrgarch_sged= pre_gjrgarch_fast1
write.csv(eth_gjrgarch_sged,"eth_gjrgarch_sged.csv")
eth_gjrgarch_sged= read.csv("eth_gjrgarch_sged.csv")
eth_gjrgarch_sged= eth_gjrgarch_sged[,-1]
...
etherum_garch_mean_jsu= fit_mean_garch
etherum_garch_jsu= pre_garch_fast1

write.csv(etherum_garch_mean_jsu,"etherum_garch_mean_jsu.csv")
etherum_garch_mean= read.csv("etherum_garch_mean_jsu.csv")
etherum_garch_mean= etherum_garch_mean[,-1]
#write.csv(etherum_garch_jsu,"etherum_garch_jsu.csv")
etherum_garch_vol_jsu= read.csv("etherum_garch_jsu.csv")
eth_garch_jsu= etherum_garch_vol_jsu[,-1]
...
bid_nagarch_binance_eth_jsu= pre_nagarch_binance
write.csv(bid_nagarch_binance_eth_jsu,"bid_nagarch_binance_eth_jsu.csv")
nagarch_binance_eth_jsu= read.csv("bid_nagarch_binance_eth_jsu.csv")
eth_nagarch_jsu= nagarch_binance_eth_jsu[,-1]
...
eth_gjrgarch_jsu= pre_gjrgarch_fast1
write.csv(eth_gjrgarch_jsu,"eth_gjrgarch_jsu.csv")
eth_gjrgarch_jsu= read.csv("eth_gjrgarch_jsu.csv")
eth_gjrgarch_jsu= eth_gjrgarch_jsu[,-1]
...
VaR_sstd_garch =  (eth_garch_sstd)*qdist("sstd", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sstd)["skew"],
                                         shape=coef(e_garch_sstd)["shape"])

VaR_sstd_nor_cop =  (adj_eth_vol_nor)*qdist("sstd", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sstd)["skew"],
                                            shape=coef(e_garch_sstd)["shape"])


VaR_sstd_t_cop =  (adj_eth_t_vol)*qdist("sstd", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sstd)["skew"],
                                        shape=coef(e_garch_sstd)["shape"])



VaR_sstd_carr =   (adj_eth_carr_vol)*qdist("sstd", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sstd)["skew"],
                                           shape=coef(e_garch_sstd)["shape"])

VaR_sstd_nagarch =  (eth_nagarch_sstd)*qdist("sstd", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sstd)["skew"],
                                             shape=coef(e_garch_sstd)["shape"])
VaR_sstd_gjrgarch =  (eth_gjrgarch_sstd)*qdist("sstd", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sstd)["skew"],shape=coef(e_garch_sstd)["shape"])
...
VaR_ged_garch =  (eth_garch_ged)*qdist("ged", p=0.05, mu = 0, sigma = 1, 
                                       shape=coef(e_garch)["shape"])

VaR_ged_nor_cop =  (adj_eth_vol_nor)*qdist("ged", p=0.05, mu = 0, sigma = 1, 
                                           shape=coef(e_garch)["shape"])


VaR_ged_t_cop =  (adj_eth_t_vol)*qdist("ged", p=0.05, mu = 0, sigma = 1, 
                                       shape=coef(e_garch)["shape"])



VaR_ged_carr =   (adj_eth_carr_vol)*qdist("ged", p=0.05, mu = 0, sigma = 1, 
                                          shape=coef(e_garch)["shape"])

VaR_ged_nagarch =  (eth_nagarch_ged)*qdist("ged", p=0.05, mu = 0, sigma = 1, 
                                           
                                           shape=coef(e_garch)["shape"])
VaR_ged_gjrgarch =  (eth_gjrgarch_ged)*qdist("ged", p=0.05, mu = 0, sigma = 1,shape=coef(e_garch)["shape"])
...
VaR_sged_garch =  (eth_garch_sged)*qdist("sged", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sged)["skew"],
                                         shape=coef(e_garch_sged)["shape"])

VaR_sged_nor_cop =  (adj_eth_vol_nor)*qdist("sged", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sged)["skew"],
                                            shape=coef(e_garch_sged)["shape"])


VaR_sged_t_cop =  (adj_eth_t_vol)*qdist("sged", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sged)["skew"],
                                        shape=coef(e_garch_sged)["shape"])



VaR_sged_carr =   (adj_eth_carr_vol)*qdist("sged", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sged)["skew"],
                                           shape=coef(e_garch_sged)["shape"])

VaR_sged_nagarch =  (eth_nagarch_sged)*qdist("sged", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sged)["skew"],
                                             shape=coef(e_garch_sged)["shape"])
VaR_sged_gjrgarch =  (eth_gjrgarch_sged)*qdist("sged", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_sged)["skew"],shape=coef(e_garch_sged)["shape"])
...
VaR_jsu_garch =  (eth_garch_jsu)*qdist("jsu", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_jsu)["skew"],
                                       shape=coef(e_garch_jsu)["shape"])

VaR_jsu_nor_cop =  (adj_eth_vol_nor)*qdist("jsu", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_jsu)["skew"],
                                           shape=coef(e_garch_jsu)["shape"])


VaR_jsu_t_cop =  (adj_eth_t_vol)*qdist("jsu", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_jsu)["skew"],
                                       shape=coef(e_garch_jsu)["shape"])



VaR_jsu_carr =   (adj_eth_carr_vol)*qdist("jsu", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_jsu)["skew"],
                                          shape=coef(e_garch_jsu)["shape"])

VaR_jsu_nagarch =  (eth_nagarch_jsu)*qdist("jsu", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_jsu)["skew"],
                                           shape=coef(e_garch_jsu)["shape"])
VaR_jsu_gjrgarch =  (eth_gjrgarch_jsu)*qdist("jsu", p=0.05, mu = 0, sigma = 1, skew=coef(e_garch_jsu)["skew"],shape=coef(e_garch_jsu)["shape"])
...
backtest_msgarch= BacktestVaR(data = actual, VaR = eth_msgarch_var_05, alpha = 0.05)
...
# Expected shortfall and McF Test sstd distribution

f1 = function(x) qdist("sstd", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sstd)["skew"],
                       shape=coef(e_garch_sstd)["shape"])

ES_sstd_garch = (eth_garch_sstd)*integrate(f1, 0, 0.05)$value/0.05
...
f2 = function(x) qdist("sstd", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sstd)["skew"],
                       shape=coef(e_garch_sstd)["shape"])
ES_sstd_nor_vol = (adj_eth_vol_nor)*integrate(f2, 0, 0.05)$value/0.05
# McF test
...
f4 = function(x) qdist("sstd", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sstd)["skew"],
                       shape=coef(e_garch_sstd)["shape"])
ES_sstd_t_vol = (adj_eth_t_vol)*integrate(f4, 0, 0.05)$value/0.05
# McF test
...
f3 = function(x) qdist("sstd", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sstd)["skew"],
                       shape=coef(e_garch_sstd)["shape"])
ES_sstd_carr = (adj_eth_carr_vol)*integrate(f3, 0, 0.05)$value/0.05
# McF test
...
f5 = function(x) qdist("sstd", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sstd)["skew"],
                       shape=coef(e_garch_sstd)["shape"])
ES_sstd_nagarch = (eth_nagarch_sstd)*integrate(f5, 0, 0.05)$value/0.05
# McF test
mcf_sstd_nagarch= (ESTest(0.05, actual, ES_sstd_nagarch, VaR_sstd_nagarch, boot = TRUE))

# McF test
mcf_msgarch=(ESTest(0.05, actual, eth_msgarch_es_05, eth_msgarch_var_05, boot = TRUE))
...
ES_sstd_gjrgarch = (eth_gjrgarch_sstd)*integrate(f6, 0, 0.05)$value/0.05

# McF test
mcf_sstd_gjrgarch=(ESTest(0.05, actual, ES_sstd_gjrgarch, VaR_sstd_gjrgarch, boot = TRUE))


#McF test with ged distribution
f1_ged = function(x) qdist("ged", p=x, mu = 0, sigma = 1,
                           shape=coef(e_garch)["shape"])



ES_ged_garch = (eth_garch_ged)*integrate(f1_ged, 0, 0.05)$value/0.05
...
f2_ged = function(x) qdist("ged", p=x, mu = 0, sigma = 1,
                           shape=coef(e_garch)["shape"])
ES_ged_nor_vol = (adj_eth_vol_nor)*integrate(f2_ged, 0, 0.05)$value/0.05
# McF test
...
f4_ged = function(x) qdist("ged", p=x, mu = 0, sigma = 1,
                           shape=coef(e_garch)["shape"])
ES_ged_t_vol = (adj_eth_t_vol)*integrate(f4_ged, 0, 0.05)$value/0.05
# McF test
...
f3_ged = function(x) qdist("ged", p=x, mu = 0, sigma = 1,
                           shape=coef(e_garch)["shape"])
ES_ged_carr = (adj_eth_carr_vol)*integrate(f3_ged, 0, 0.05)$value/0.05
# McF test
mcf_ged_carr= (ESTest(0.05, actual, ES_ged_carr, VaR_ged_carr, boot = TRUE))

f5_ged = function(x) qdist("ged", p=x, mu = 0, sigma = 1,
                           shape=coef(e_garch)["shape"])
ES_ged_nagarch = (eth_nagarch_ged)*integrate(f5_ged, 0, 0.05)$value/0.05
# McF test
...
# Expected shortfall and McF Test sged distribution

f1 = function(x) qdist("sged", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sged)["skew"],
                       shape=coef(e_garch_sged)["shape"])

ES_sged_garch = (eth_garch_sged)*integrate(f1, 0, 0.05)$value/0.05
...
f2 = function(x) qdist("sged", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sged)["skew"],
                       shape=coef(e_garch_sged)["shape"])
ES_sged_nor_vol = (adj_eth_vol_nor)*integrate(f2, 0, 0.05)$value/0.05
# McF test
...
f4 = function(x) qdist("sged", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sged)["skew"],
                       shape=coef(e_garch_sged)["shape"])
ES_sged_t_vol = (adj_eth_t_vol)*integrate(f4, 0, 0.05)$value/0.05
# McF test
...
f3 = function(x) qdist("sged", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sged)["skew"],
                       shape=coef(e_garch_sged)["shape"])
ES_sged_carr = (adj_eth_carr_vol)*integrate(f3, 0, 0.05)$value/0.05
# McF test
...
f5 = function(x) qdist("sged", p=x, mu = 0, sigma = 1,skew=coef(e_garch_sged)["skew"],
                       shape=coef(e_garch_sged)["shape"])
ES_sged_nagarch = (eth_nagarch_sged)*integrate(f5, 0, 0.05)$value/0.05
# McF test
...
ES_sged_gjrgarch = (eth_gjrgarch_sged)*integrate(f6, 0, 0.05)$value/0.05

# McF test
mcf_sged_gjrgarch=(ESTest(0.05, actual, ES_sged_gjrgarch, VaR_sged_gjrgarch, boot = TRUE))

# Expected shortfall and McF Test jsu distribution

f1 = function(x) qdist("jsu", p=x, mu = 0, sigma = 1,skew=coef(e_garch_jsu)["skew"],
                       shape=coef(e_garch_jsu)["shape"])

ES_jsu_garch = (eth_garch_jsu)*integrate(f1, 0, 0.05)$value/0.05
...
f2 = function(x) qdist("jsu", p=x, mu = 0, sigma = 1,skew=coef(e_garch_jsu)["skew"],
                       shape=coef(e_garch_jsu)["shape"])
ES_jsu_nor_vol = (adj_eth_vol_nor)*integrate(f2, 0, 0.05)$value/0.05
# McF test
...
f4 = function(x) qdist("jsu", p=x, mu = 0, sigma = 1,skew=coef(e_garch_jsu)["skew"],
                       shape=coef(e_garch_jsu)["shape"])
ES_jsu_t_vol = (adj_eth_t_vol)*integrate(f4, 0, 0.05)$value/0.05
# McF test
...
f3 = function(x) qdist("jsu", p=x, mu = 0, sigma = 1,skew=coef(e_garch_jsu)["skew"],
                       shape=coef(e_garch_jsu)["shape"])
ES_jsu_carr = (adj_eth_carr_vol)*integrate(f3, 0, 0.05)$value/0.05
# McF test
...
f5 = function(x) qdist("jsu", p=x, mu = 0, sigma = 1,skew=coef(e_garch_jsu)["skew"],
                       shape=coef(e_garch_jsu)["shape"])
ES_jsu_nagarch = (eth_nagarch_jsu)*integrate(f5, 0, 0.05)$value/0.05
# McF test
...
ES_jsu_gjrgarch = (eth_gjrgarch_jsu)*integrate(f6, 0, 0.05)$value/0.05
...
NF_msgarch= cc_backtest(actual, eth_msgarch_var_05, eth_msgarch_es_05, alpha=0.05)
...
BD_msgarch= esr_backtest(actual, eth_msgarch_var_05, eth_msgarch_es_05, alpha=0.05,version = 1)
...
FZL_msgarch= mean(FZLoss(actual, eth_msgarch_var_05, eth_msgarch_es_05, alpha=0.05))
...
write.csv(Table, "Table_eth_05.csv")
